...
const CreateGuidelinesForm = ({ formData, setFormData, handleButtonClick, getAIText, isAIGenerating }: Props) => {
        ...
        <div className="fixed flex justify-end w-full max-w-[400px] z-50 right-4 bottom-4">
            {!expand ? (
                ...
                <div className="p-4 w-full bg-white rounded-md shadow-lg">
                    <h1 className="text-xl font-semibold mb-4">Create Project Guidelines</h1>
